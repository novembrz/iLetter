...
class UserCell: UICollectionViewCell, SelfConfiguringCell{
    ...
    let containerView = UIView() //чтобы одновременно и тени и закругления
    ...
    func configure<U>(with value: U) where U : Hashable {
        guard let user: LetterUser = value as? LetterUser else { return }
...
struct UserProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: UIViewControllerRepresentableContext<UserProvider.ContainerView>) -> MainTabBarController {
            return tabBarVC
        }
