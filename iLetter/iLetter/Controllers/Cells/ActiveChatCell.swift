...
class ActiveChatCell: UICollectionViewCell, SelfConfiguringCell {
    ...
    let gradientView = GradientView(from: .topTrailing, to: .bottomLeading, startColor: #colorLiteral(red: 0.4745098039, green: 0.8901960784, blue: 0.7490196078, alpha: 1), endColor: #colorLiteral(red: 0.4784313725, green: 0.6980392157, blue: 0.9215686275, alpha: 1))
